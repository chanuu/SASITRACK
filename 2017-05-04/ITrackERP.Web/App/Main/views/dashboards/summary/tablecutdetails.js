...
// 6A3D9A - purple     1F79B4 - Blue     FE6383 - pink
                ...
                dailyproductionAppService.getProductionSummary({
                    ...
                    angular.forEach($rootScope.pdata, function (value, index) {
                        ...
                        angular.forEach(value, function (value1, index1) {
                            ...
                            $rootScope.pdataformated.push({ styleNo: value1.styleNo, date: value1.date, lineNo: value1.lineNo, poNo: value1.poNo, color: value1.color, size: value1.size, lineIn: value1.lineIn, lineInCumm: value1.lineInCumm, lineInTotal: value1.lineInTotal, lineOut: value1.lineOut, lineOutCumm: value1.lineOutCumm, lineOutTotal: value1.lineOutTotal });
                        });
            ...
            $rootScope.getLineInTotal = function (items) {
                return items
                .map(function (x) { return x.lineIn; })
                .reduce(function (w, z) { return w + z; });
            };

            $rootScope.getLineInTotals = function (items) {
                return items
                .map(function (x) { return x.lineInTotal; })
                .reduce(function (w, z) { return w + z; });
            };

            $rootScope.getLineInCumm = function (items) {
                return items
                .map(function (x) { return x.lineInCumm; })
                .reduce(function (w, z) { return w + z; });
            };

            $rootScope.getLineOutTotal = function (items) {
                return items
                .map(function (x) { return x.lineOut; })
                .reduce(function (w, z) { return w + z; });
            };

            $rootScope.getLineOutTotals = function (items) {
                return items
                .map(function (x) { return x.lineOutTotal; })
                .reduce(function (w, z) { return w + z; });
            };

            $rootScope.getLineOutCumm = function (items) {
                return items
                .map(function (x) { return x.lineOutCumm; })
                .reduce(function (w, z) { return w + z; });
            };
