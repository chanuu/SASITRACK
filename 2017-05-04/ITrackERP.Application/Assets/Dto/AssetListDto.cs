...
namespace ITrackERP.Assets.Dto
{
    ...
    public class AssetListDto : FullAuditedEntityDto<Guid>
    {
    ...
    [AutoMapFrom(typeof(Asset))]
    public class AssetListShort : FullAuditedEntityDto<Guid>
    {
        public int TenantId { get; set; }
        public string AssetNo { get; set; }
    ...
    [AutoMapFrom(typeof(Asset))]
    public class AssetNoInputDto : FullAuditedEntityDto<Guid>
    {
        public string AssetNo { get; set; }
    }
