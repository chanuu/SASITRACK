(function () {
    ...
    angular.module('app').controller(controllerId, [
        '$scope', '$state', '$stateParams', 'abp.services.app.machineRequirement', 'abp.services.app.style',
        function ($scope, $state, $stateParams, machinerequirementService, styleService) {
            var vm = this;
            $scope.styles = [];
