    ...
    app.config([
            ...
            $stateProvider
                .state('home', {
                 ...
                 //timeline
                  .state('timeline', {
                      url: '/timeline',
                      templateUrl: '/App/Main/views/timeline/index.cshtml',
                      menu: 'TimeLine' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })

                   //category
                  .state('category', {
                      url: '/category',
                      templateUrl: '/App/Main/views/categories/index.cshtml',
                      menu: 'CategorySetUp' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })
                .state('categoryDetail', {
                    url: '/category/:id',
                    templateUrl: '/App/Main/views/categories/detail.cshtml',
                    menu: 'CategorySetUp' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })

                .state('categoryUpdate', {
                    url: '/category/update/:id',
                    templateUrl: '/App/Main/views/categories/update.cshtml',
                    menu: 'CategorySetUp' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })
                 ...
                 //file
                  .state('file', {
                      url: '/file',
                      templateUrl: '/App/Main/views/files/index.cshtml',
                      menu: 'File' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })
                .state('fileDetail', {
                    url: '/file/:id',
                    templateUrl: '/App/Main/views/files/detail.cshtml',
                    menu: 'File' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })

                .state('fileUpdate', {
                    url: '/file/update/:id',
                    templateUrl: '/App/Main/views/files/update.cshtml',
                    menu: 'File' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })
                 ...
                 .state('eventheaders', {
                     url: '/eventheader',
                     templateUrl: '/App/Main/views/eventheaders/index.cshtml',
                     menu: 'EventHeaders' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                 })
                .state('eventheaderDetail', {
                    url: '/eventheader/:id',
                    templateUrl: '/App/Main/views/eventheaders/detail.cshtml',
                    menu: 'EventHeaders' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })

                .state('eventheaderUpdate', {
                    url: '/eventheader/update/:id',
                    templateUrl: '/App/Main/views/eventheaders/update.cshtml',
                    menu: 'EventHeaders' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })
                .state('inviteeUpdate', {
                    url: '/eventheader/invitee/update/:id',
                    templateUrl: '/App/Main/views/eventheaders/updateInvitee.cshtml',
                    menu: 'EventHeaders' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })
                ...
                .state('buyerUpdate', {
                 ...
                 //elements
                  .state('elements', {
                      url: '/elements',
                      templateUrl: '/App/Main/views/elements/index.cshtml',
                      menu: 'Elements' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })
                .state('elementDetail', {
                    url: '/elements/:id',
                    templateUrl: '/App/Main/views/elements/detail.cshtml',
                    menu: 'Elements' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })

                .state('elementUpdate', {
                    url: '/elements/update/:id',
                    templateUrl: '/App/Main/views/elements/update.cshtml',
                    menu: 'Elements' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })
               ...
               //employees
                  ...
                  .state('employees', {
                      ...
                      menu: 'Employees' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })
                .state('employeeDetail', {
                    url: '/employees/:id',
                    templateUrl: '/App/Main/views/employees/detail.cshtml',
                    menu: 'Employees' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })

                .state('employeeUpdate', {
                    url: '/employees/update/:id',
                    templateUrl: '/App/Main/views/employees/update.cshtml',
                    menu: 'Employees' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })
                 .state('pastemploymentUpdate', {
                     url: '/employees/item/updatepastemployment/:id',
                     templateUrl: '/App/Main/views/employees/updatePastEmployment.cshtml',
                     menu: 'Employees' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                 })
                 .state('awardUpdate', {
                     url: '/employees/item/updateaward/:id',
                     templateUrl: '/App/Main/views/employees/updateAward.cshtml',
                     menu: 'Employees' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                 })
                 .state('promotionUpdate', {
                     url: '/employees/item/updatepromotion/:id',
                     templateUrl: '/App/Main/views/employees/updatePromotion.cshtml',
                     menu: 'Employees' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                 })
                ...
                .state('assetUpdate', {
                 ...
                 .state('assetverification', {
                     ...
                     templateUrl: '/App/Main/views/assetverifications/index.cshtml',
                     menu: 'AssetVerification' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                 })

                .state('assetverificationDetail', {
                    url: '/assetverification/:id',
                    templateUrl: '/App/Main/views/assetverifications/detail.cshtml',
                    menu: 'AssetVerification' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                })
        ...
        //asset disposal header and detail
                ...
                .state('updateDisposalItems',
                 ...
                 .state('issuenoteheader',
                {
                    url: '/issuenoteheader',
                    templateUrl: '/App/Main/views/issuenoteheaders/index.cshtml',
                    menu: 'IssueNoteHeaders' //Matches to name of 'About' menu in ITrackERPNavigationProvider
                })
                .state('issuenoteheaderDetail',
                {
                    url: '/issuenoteheader/:id',
                    templateUrl: '/App/Main/views/issuenoteheaders/detail.cshtml',
                    menu: 'IssueNoteHeaders' //Matches to name of 'About' menu in ITrackERPNavigationProvider
                })
                 .state('issuenoteheaderUpdate',
                  {
                      url: '/issuenoteheader/update/:id',
                      templateUrl: '/App/Main/views/issuenoteheaders/update.cshtml',
                      menu: 'IssueNoteHeaders' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })
                .state('createIssueNoteItems',
                  {
                      url: '/issuenoteheader/item/create',
                      templateUrl: '/App/Main/views/issuenoteheaders/createIssueNoteItem.cshtml',
                      menu: 'IssueNoteHeaders' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })

                .state('updateIssueNoteItems',
                  {
                      url: '/issuenoteheader/item/update/:id',
                      templateUrl: '/App/Main/views/issuenoteheaders/updateIssueNoteItem.cshtml',
                      menu: 'IssueNoteHeaders' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })
                ...
                //daily plan header
                 ...
                 .state('dailyplanheader',
                {
                    url: '/dailyplanheader',
                    templateUrl: '/App/Main/views/dailyplanheaders/index.cshtml',
                    menu: 'DailyPlanHeaders' //Matches to name of 'About' menu in ITrackERPNavigationProvider
                })
                .state('dailyplanheaderDetail',
                {
                    url: '/dailyplanheader/:id',
                    templateUrl: '/App/Main/views/dailyplanheaders/detail.cshtml',
                    menu: 'DailyPlanHeaders' //Matches to name of 'About' menu in ITrackERPNavigationProvider
                })
                 .state('dailyplanheaderUpdate',
                  {
                      url: '/dailyplanheader/update/:id',
                      templateUrl: '/App/Main/views/dailyplanheaders/update.cshtml',
                      menu: 'DailyPlanHeaders' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })
                .state('updateDailyPlantems',
                  {
                      url: '/dailyplanheader/item/update/:id',
                      templateUrl: '/App/Main/views/dailyplanheaders/updateItem.cshtml',
                      menu: 'DailyPlanHeaders' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })
            ...
            //asset transfer header and detail
              ...
              .state('createReceiveNoteItems',
                ...
                .state('workOrderItemUpdate',
                {
                    url: '/workorders/item/update/:id',
                    templateUrl: '/App/Main/views/workorders/updateWorkorderItem.cshtml',
                    menu: 'WorkOrder' //Matches to name of 'About' menu in ITrackERPNavigationProvider
                })
                  ...
                  .state('cuttingmasterupdateItem',
                  {
                      url: '/cuttingmasters/update/:id',
                      templateUrl: '/App/Main/views/cuttingmasters/updateItem.cshtml',
                      menu: 'CuttingMasters' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })
                 ...
                 .state('cuttingsum',
                  {
                      url: '/dashboards/cutting/summary',
                      templateUrl: '/App/Main/views/dashboards/cutting/summary.cshtml',
                      menu: 'Cuttingsummary' //Matches to name of 'Events' menu in ITRACKNavigationProvider
                  })
